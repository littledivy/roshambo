...
namespace haxe.lang {
	public sealed class FieldLookup {
		...
		protected static int[] fieldIds = new int[]{98, 105, 4745537, 4849249, 5393365, 5442204, 5594513, 67859554, 76061764, 87367608, 142301684, 288167040, 302979532, 328878574, 343868310, 359333139, 407283053, 452737314, 493819893, 501039929, 520590566, 946786476, 1058556349, 1067353468, 1103412149, 1113806382, 1181037546, 1204816148, 1214309137, 1224700491, 1224901875, 1228056441, 1247875546, 1280845662, 1282943179, 1352786672, 1398464674, 1431819701, 1532710347, 1547539107, 1620824029, 1621420777, 1623148745, 1648581351, 1705629508, 1763375486, 1830310359, 1873474154, 1915412854, 1916009602, 1937159360, 1981972957, 2025055113, 2054707467, 2082663554, 2127021138};
		
		protected static string[] fields = new string[]{"b", "i", "__a", "arr", "len", "map", "pop", "start", "remove", "filter", "resize", "stream", "methodName", "iterator", "dateUTC", "lastIndexOf", "hasNext", "reverse", "getBytes", "insert", "length", "toString", "_eof", "splice", "copy", "date", "join", "concat", "move", "name", "next", "enumConstructor", "push", "sort", "quicksort", "spliceVoid", "getEnumName", "createEnumIndex", "concatNative", "className", "__unsafe_get", "__unsafe_set", "indexOf", "fileName", "toDynamic", "readByte", "customParams", "readLine", "__get", "__set", "__hx_deleteField", "lineNumber", "unshift", "enumParameters", "shift", "slice"};
